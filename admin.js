...
jQuery(function($) {
	...
	$.fn.addSavingWhatItem = function(table,i,added) {
		...
		var value				= '<td class="item-value">' + item_value + '<input type="text" value="' + item_value + '" /></td>';
		...
		if (false === added)
			...
			if (table.find('tbody tr.updated').length)
				table.find('tbody tr.updated').after(html);
	...
	$(document).ready(function() {
		...
		var w = table.width();
		table.find('thead').css('width',w + 'px');
